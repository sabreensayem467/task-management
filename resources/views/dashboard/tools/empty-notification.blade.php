...
@section('title','empty notification')
@section('content')
    ...
    <div class="app-content">
        <div class="tf-container">
            ...
            <div class="box-empty-noti">
                <img src="images/background/empty-task2.jpg" alt="empty-notification">
                <div class="mt-40">
                    <h5 class="text-black-2 text-center">Ups! There is no notification</h5>
                    <p class="mt-12 text-black-5 text-center px-5 body-2">You’ll be notified about activity on tasks
                        you’re a collaborator on.</p>
                </div>
            </div>
