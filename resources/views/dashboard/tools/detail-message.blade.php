                ...
                <div class="d-flex gap-12 align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between">
                            <div class="font-title-btn fw-7 text-black-2">Annette Black</div>    
                            <p class="text-caption-2 text-black-4">Today at 11:20AM</p>
                        </div>
                        <p class="mt-6 body-2 text-black-4">annetteblack@gmail.com</p>
                    </div>
                    
                </div>
            </div>
        </div>
        <div class="mt-14 pb-30 line-bt2">
            <div class="tf-container content-message">
                <div class="content-message">
                    <input type="text" class="ip-message" value="Hi sis,">
                    <textarea class="mt-24 area-message">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</textarea>
                    <textarea class="mt-24 area-message st-1">Velit officia consequat duis enim velit mollit. Exercitation veniam consequat  sunt nostrud amet.</textarea>
                    <input type="text" class="ip-message mt-14" value="Regards">
                </div>
                <a href="javascript:void(0);" class="mt-24 wd-file-message">
        ...
        <div class="py-16 line-bt2">
            <div class="tf-container">
                <div class="d-flex justify-content-between align-items-center gap-20">
                    <span class="icon-corner-up-left fs-24 text-black-5"></span>
                    <div class="flex-grow-1">
                        <div class="font-title-btn fw-7 text-black-2"><a href="javascript:void(0);">Annette Black</a></div>
                        <p class="body-2 mt-6 text-black-4">annetteblack@gmail.com</p>
                    </div>
                    <div class="d-flex gap-16 align-items-center">
                        <a href="javascript:void(0);" class="fs-20 text-black-5 icon-trash"></a>
                        <a href="javascript:void(0);" class="fs-18 text-black-5 icon-more"></a>
                    </div>  
                </div>
            </div>
        </div>
        <div class="content-message mt-24">
            <div class="tf-container">
                <input type="text" class="ip-message" value="Hi sis,">
                <input type="text" class="ip-message mt-24" value="Thanks for your quick response. Keep up the great work">
                <input type="text" class="ip-message mt-24" value="Regards">
            </div>
        </div>
        <div class="footer-fixed fixed-message">
            <a href="inbox.html" class="tf-btn primary btn-sm inline">Send Message</a>
            <div class="d-flex align-items-center gap-16">
                <a href="javascript:void(0);">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="2" y="2" width="20" height="20" rx="4" fill="white" stroke="#5A6172" stroke-width="1.5"/>
                        <path d="M15.608 7V8.036H12.948V16.758H11.674V8.036H9V7H15.608Z" fill="#5A6172"/>
                    </svg>    
                </a>
                <a href="#attachments" data-bs-toggle="offcanvas" aria-controls="offcanvasBottom">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19 9.77778V15.3333C19 17.1014 18.2625 18.7971 16.9497 20.0474C15.637 21.2976 13.8565 22 12 22C10.1435 22 8.36301 21.2976 7.05025 20.0474C5.7375 18.7971 5 17.1014 5 15.3333V6.44444C5 5.2657 5.49167 4.13524 6.36683 3.30175C7.242 2.46825 8.42899 2 9.66667 2V2C10.9043 2 12.0913 2.46825 12.9665 3.30175C13.8417 4.13524 14.3333 5.2657 14.3333 6.44444V15.3333C14.3333 15.9227 14.0875 16.4879 13.6499 16.9047C13.2123 17.3214 12.6188 17.5556 12 17.5556C11.3812 17.5556 10.7877 17.3214 10.3501 16.9047C9.9125 16.4879 9.66667 15.9227 9.66667 15.3333V6.44444" stroke="#5A6172" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>  
                </a>
                <a href="javascript:void(0);">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 6H5H21" stroke="#5A6172" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M8 6V4C8 3.46957 8.21071 2.96086 8.58579 2.58579C8.96086 2.21071 9.46957 2 10 2H14C14.5304 2 15.0391 2.21071 15.4142 2.58579C15.7893 2.96086 16 3.46957 16 4V6M19 6V20C19 20.5304 18.7893 21.0391 18.4142 21.4142C18.0391 21.7893 17.5304 22 17 22H7C6.46957 22 5.96086 21.7893 5.58579 21.4142C5.21071 21.0391 5 20.5304 5 20V6H19Z" stroke="#5A6172" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>  
                </a>
                <a href="javascript:void(0);">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7 12C7 10.8954 6.10457 10 5 10C3.89543 10 3 10.8954 3 12C3 13.1046 3.89543 14 5 14C6.10457 14 7 13.1046 7 12Z" fill="#5A6172"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M14 12C14 10.8954 13.1046 10 12 10C10.8954 10 10 10.8954 10 12C10 13.1046 10.8954 14 12 14C13.1046 14 14 13.1046 14 12Z" fill="#5A6172"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M21 12C21 10.8954 20.1046 10 19 10C17.8954 10 17 10.8954 17 12C17 13.1046 17.8954 14 19 14C20.1046 14 21 13.1046 21 12Z" fill="#5A6172"/>
                    </svg> 
                </a>
            </div>
        </div>
