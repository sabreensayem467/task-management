...
@section('content')
        ...
        <div class="section-box-search">
            <div class="tf-container">
                <div class="search-box style-1">
                    ...
                    <form method="get"action="{{route('get_project')}}">
                        @csrf
                    <input type="text" class="search-field" placeholder="Find your task" value="nft website de" name="search">
                    </form>
                </div>
            </div>
        </div>
                                    ...
                                    <a href="project-details.html" class="box-recent-project">
                                        <div class="top">
                                            <div class="d-flex justify-content-between align-items-center gap-10">
                                                ...
                                                <div class="h8 fw-bold flex-grow-1">{{$val->name}}</div>
                                                <span>
                                            ...
                                            <ul class="mt-14 d-flex gap-8 meta-list">
                                                <li class="meta-item"><i class="icon-calendar fs-12"></i>{{$val->date}}</li>
                                                <li class="meta-item"><i class="icon-chat2 fs-12"></i> {{$val->num_team}}</li>
    ...
    <div class="menubar-footer footer-fixed st-1">
        <ul class="inner-bar">
            <li class="active">
                <a href="index.html">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
